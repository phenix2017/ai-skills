...
> 📦 属于 **[offer-toolkit-skill](offer-toolkit-skill)** 求职工具包 — 装工具包等于一次性拿到 JD · Resume · BQ · Salary 四条子 skill。
...
跟这三条串起来 — JD → Resume → BQ 拿到 offer，再回这里 close：

- [offer-toolkit-skill](offer-toolkit-skill) — 四件套（JD · Resume · BQ · Salary）
