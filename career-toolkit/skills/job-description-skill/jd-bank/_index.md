...
| 文件 | 公司 | 岗位 | Match | ⭐ | 候选人 |
|---|---|---|---|---|---|
| [linear-principal-product-designer-202606.md](linear-principal-product-designer-202606.md) | Linear | Principal Product Designer | 70–80% | 3.5/5 | Candidate |
| [xai-exceptional-designer-202606.md](xai-exceptional-designer-202606.md) | xAI | Exceptional Designer | 78–85% | 4/5 | Candidate |
| [anthropic-product-designer-claude-code-202606.md](anthropic-product-designer-claude-code-202606.md) | Anthropic | Product Designer, Claude Code | 80–88% | 4.5/5 | Candidate |
