...
[![Stars](https://img.shields.io/github/stars/career-toolkit/salary-negotiation?style=flat-square&label=STARS&color=e37f2c&labelColor=333)](salary-negotiation/stargazers)
...
> 📦 Part of the **[offer-toolkit-skill](offer-toolkit-skill)** — the full job-hunt bundle (JD · Resume · BQ · Salary). Install the bundle to get all four in one shot.
...
Pairs with these three — get the offer through JD → Resume → BQ, then close it here:

- [offer-toolkit-skill](offer-toolkit-skill) — the all-in-one bundle (JD · Resume · BQ · Salary)
