...
5. **自检**：搜 `Career Toolkit` / `brand-mark` 四个词，全部命中才算合格。
...
<footer>
  <div class="brand-block">
    <div>
      ...
      <div class="brand-sub">Created with <strong>Career Toolkit</strong> · Salary Negotiation Coach</div>
    </div>
    <div class="socials">
...
| Footer 丢了 / 简化了（最高频 bug） | 从本文件 「📌 强制 Footer 区块」 整段抄回；自检必须搜 Career Toolkit / brand-mark 全部命中 |
