...
[![Stars](https://img.shields.io/github/stars/career-toolkit/offer-compare-skill?style=flat-square&label=STARS&color=e37f2c&labelColor=333)](offer-compare-skill/stargazers)
...
> 📦 Part of the **[offer-toolkit-skill](offer-toolkit-skill)** — the full job-hunt bundle (JD · Resume · BQ · Compare · Salary). Install the bundle to get all of them in one shot.
...
- [offer-toolkit-skill](offer-toolkit-skill) — the all-in-one bundle (JD · Resume · BQ · Compare · Salary)
- [job-description-skill](job-description-skill) — Job Description decoder + should-I-apply
...
- [salary-negotiation-skill](salary-negotiation-skill) — Negotiate the offer you picked here
