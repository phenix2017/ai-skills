...
> 📦 属于 **[offer-toolkit-skill](offer-toolkit-skill)** 求职工具包 — 装工具包等于一次性拿到 JD · Resume · BQ · Compare · Salary 全部子 skill。
...
- [offer-toolkit-skill](offer-toolkit-skill) — 全家桶（JD · Resume · BQ · Compare · Salary）
- [job-description-skill](job-description-skill) — JD 解码器 + should-I-apply
- [resume-builder-skill](resume-builder-skill) — 简历生成与美化（11 套打印级模板）
- [behavior-question-skill](behavior-question-skill) — 行为面试 / 职业故事库
- [salary-negotiation-skill](salary-negotiation-skill) — 谈这里选出来的那份 offer
