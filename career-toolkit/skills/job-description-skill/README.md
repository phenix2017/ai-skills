...
[![Stars](https://img.shields.io/github/stars/career-toolkit/job-description-skill?style=flat-square&label=STARS&color=e37f2c&labelColor=333)](job-description-skill/stargazers)
...
> 📦 Part of the **[offer-toolkit-skill](offer-toolkit-skill)** — the full job-hunt bundle (JD · Resume · BQ). Install the bundle to get all three in one shot.
...
2. **Give it your resume** — three options:
   ...
   - 🅲️ No resume yet → short self-introduction. Results will be flagged as "unverified against a real resume" and you'll be nudged toward **[Resume Skill](resume-builder-skill)** to build one.
...
That's the whole thing. No multi-step wizard, no separate "decode only" / "match score only" outputs to wade through — the 5 internal flows (Decode / Match / Tailor / Predict / Should I Apply) all run silently and assemble into the same HTML report.
...
| **3** | **JD deep decode** | Why this JD reads the way it does (5-layer decode + Hidden Signal dictionary hits). |
...
| **9** | **Top 10 interview questions** | Interview prediction preview. Full Top 20 + behavior stories → hand off to BQ Skill. |
...
- [offer-toolkit-skill](offer-toolkit-skill) — the all-in-one bundle (JD · Resume · BQ)
- [resume-builder-skill](resume-builder-skill) — Resume Builder & Beautifier (11 print-ready templates)
- [Behavior-question-skill](Behavior-question-skill) — Behavioral interview / story bank
